...
class RedirectView(FormView):
    ...
    def form_valid(self, form):
        ...
        request.merchant_url = reverse("redsys:response")
        request.url_ok = reverse("redsys:transaction-accepted")
        request.url_ko = reverse("redsys:transaction-rejected")
        request.currency = settings.REDSYS_MERCHANT_CURRENCY
        request.transaction_type = settings.REDSYS_MERCHANT_TRANSACTIONTYPE
